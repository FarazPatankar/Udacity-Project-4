...
//Variables randomPizza and pizzaSizes are saved with getElementById for quicker work.
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //Changed the number of iterations to 32 as the pizzas are in a fixed position.
  for (var i = 0; i < 32; i++) {
